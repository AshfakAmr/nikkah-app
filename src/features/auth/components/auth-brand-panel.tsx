...
export function AuthBrandPanel({ className }: AuthBrandPanelProps) {
  return (
    <aside
      className={cn(
        "relative flex items-center justify-center overflow-hidden bg-surface-cream px-6 py-10 sm:px-10 lg:min-h-full lg:px-10 lg:py-14 xl:px-12",
        className,
      )}
    >
      <Image
      ...
      />
      <div className="absolute inset-0 bg-linear-to-br from-surface-cream/25 via-transparent to-surface-beige/15" />

      <div className="relative z-10 mx-auto flex w-full max-w-md flex-col gap-8 lg:max-w-lg lg:gap-9">
        <h1 className="font-serif text-[clamp(2rem,4vw,3.25rem)] leading-[1.15] text-text-primary">
        ...
        <figure className="rounded-2xl border-l-4 border-primary bg-surface-white/85 p-5 shadow-card backdrop-blur-md">
